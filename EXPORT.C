...
const char *bar = "ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ";
...
s16 listGeneralConfig (void)
{
   ...
   fprintf (textFile, "ÃÕ Topic 1        : %s\n", config.topic1);
   fprintf (textFile, "»Õ Topic 2        : %s\n", config.topic2);
...
#ifndef __FMAILX__
#ifndef __32BIT__
   fprintf (textFile, "»Õ Use 64k EMS    : %s\n", config.genOptions.useEMS ? "Yes":"No");
#endif
#endif
